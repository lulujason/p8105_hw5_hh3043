...
It is because when true mean is small, the effect size is small. Then the power is less. Thus these mu hat out of the confidence interval are in general larger than mu hat from out of confidence interval in larger mu samples. For larger mu, the effect size and power will be larger, then there are more samples with rejected null. The higher the proportion of these samples in the whole sample, the more approximate of these mu hat to the true mean.
