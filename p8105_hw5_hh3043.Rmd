...
From the plot, the observation values for experiment group is in a increasing trend through week 1 to week 8,but the trend for control group is relatively constant.
...
sim_results_df|>
  group_by(mu)|>
  summarize(power = sum(p_value<0.05)/500)|>
...
according to the plot, the sample average of μ hat across tests for which the null is rejected approximately equal to the true value of μ. It is because that these rejected μ hat distribute symmetrically about the true μ value.
