...
according to the plot, the sample average of μ hat across tests for
which the null is rejected approximately equal to the true value of μ.
It is because that these rejected μ hat distribute symmetrically about
the true μ value.
